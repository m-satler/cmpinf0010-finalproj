...
## An objective measurement of Pittsburgh's best neighborhood as determined by the median age of death, water features, and firearm seizures in each neighborhood.
### cmpinf0010-finalproj
Team Einstein's 

-  Galonsky gjg56@pitt.edu

- Mei Satler mls410@pitt.edu

### Data Sets
[Median Age of Death](https://data.wprdc.org/dataset/median-age-death)
- This data set records the age of death for residents of Pittsburgh from 2011 to 2015. The time of death is based on official records and the location is based on the deceased's primary address, not true location of death.
- https://data.wprdc.org/dataset/median-age-death

[Firearm Seizures](https://data.wprdc.org/dataset/pbp-fire-arm-seizures)
- This data set records the firearm seizures done by the Pittsburgh Police from 2015 to 2022. Seizures may be done if the police suspect involvement in a crime or for the health of the public or for the health of an officer. Exact dates are anonymized for privacy concerns.
- https://data.wprdc.org/dataset/pbp-fire-arm-seizures

[Water Features](https://data.wprdc.org/dataset/city-water-features)
- This data set records the location and type of different water features in the Pittsburgh area. Water features include primarily water fountains, spray fountains, and decorative fountains, among others.
